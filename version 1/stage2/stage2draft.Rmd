...
grid_lasso <- grid_regular(penalty(range = c(-5, 0)), levels = 3)
grid_tree  <- grid_regular(tree_depth(), cost_complexity(), levels = 3)
grid_rf    <- grid_regular(mtry(range = c(3L, 10L)), min_n(), levels = 3)
